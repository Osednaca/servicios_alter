...
if($stmt->error == ""){
	...
	while ($stmt->fetch()) {
		...
		$mensajes[] = array('idmensaje'=>$idmensaje,'idservicio'=>$idservicio,'idremitente'=>$idremitente,'iddestinatario'=>$iddestinatario,'mensaje'=>$mensaje,'estatus'=>$estatus,'fechaenvio'=>$fechaenvio,'escliente'=>$escliente);
	}
