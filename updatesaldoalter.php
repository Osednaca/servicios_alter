<?php
	...
	*/
	...
	while($stmt->fetch()){
		$saldodisponible = calcularsaldodisponible($idusuario,false,$fechaultimocorte);
		...
		$log .= "IDUsuario: $nombre $apellido Saldo: ".$saldodisponible["ingresototales"]." Ultimo corte: ".$saldodisponible["ultimocorte"]."\n";
...
//
		...
		//echo "$idusuario,$fechaultimocorte,$fechanow"; die();
